...
export const WeChatPreview = forwardRef<HTMLDivElement, WeChatPreviewProps>(({
  ...
  return (
    <div className={`absolute inset-0 overflow-y-auto overflow-x-hidden ${visible ? 'z-10 visible' : 'z-0 invisible'} bg-gray-100`}>
        <div className={`w-full min-h-full flex justify-center py-8 origin-center transition-all duration-300 ease-out delay-75 ${
            ...
            {/* Simulation Phone Container */}
            <div 
                className="w-[375px] md:w-[414px] bg-white min-h-[800px] shadow-xl relative flex flex-col"
                ref={ref}
            >   
                {/* WeChat Header */}
